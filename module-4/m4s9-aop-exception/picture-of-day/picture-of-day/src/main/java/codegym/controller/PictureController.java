...
public class PictureController {
    ...
    public String index(Model model,
                        ...
                        @RequestParam("sort") Optional<String> sort) throws BadWordFilterException {
        if (likeId.isPresent()) {
    ...
    @PostMapping("/comment")
    public String save(Comment comment) throws BadWordFilterException {
    ...
    public String like(@RequestParam("likeId") Integer likeId,
                       @RequestParam("page") Integer page) throws BadWordFilterException {
    ...
    @ExceptionHandler(BadWordFilterException.class)
    public String badWordExceptionHandling() {
        return "bad-words-exception";
    }
}
